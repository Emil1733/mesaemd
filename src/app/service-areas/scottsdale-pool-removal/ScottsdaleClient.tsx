  ...
  const handleLeadSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from('emd_leads_atlanta').insert([{
        ...
        source_page: 'Scottsdale City Page',
      }]);
    ...
    <main className={styles.main}>
      ...
      <section className={styles.hero} style={{ minHeight: '80vh', background: '#0a0a0a' }}>
        <Image
          ...
          alt="Concrete pool demolition in Scottsdale Arizona"
          fill
          priority
          ...
          <div className={styles.heroGrid}>
            <div className="fade-in">
              <div style={{ display: 'inline-block', background: 'var(--accent-primary)', color: '#000', padding: '0.4rem 1rem', fontWeight: 900, fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1.5rem' }}>
                Scottsdale, AZ Service Area
              </div>
              <h1 className={styles.heroTitle} style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', marginBottom: '1.5rem' }}>
                Professional Pool Removal in Scottsdale
              </h1>
              <p className={styles.heroDesc} style={{ fontSize: '1.15rem', maxWidth: '600px', lineHeight: 1.8 }}>
                Are you tired of paying thousands of dollars every year to maintain an aging, leaking, or unused swimming pool in Scottsdale? Our licensed and insured demolition teams specialize in full structural removal, partial fill-ins, and engineered backfill compaction specifically designed for the hard caliche and rocky terrain found throughout the Scottsdale area.
              </p>
              <ul className={styles.trustBullets} style={{ marginTop: '2rem' }}>
                <li>Engineered 95% compaction backfill</li>
                <li>Scottsdale city permits managed for you</li>
            ...
            <div className="fade-in" style={{ animationDelay: '0.2s', background: 'var(--bg-dark)', padding: '2rem', border: '1px solid var(--border-light)' }}>
              <div style={{ fontSize: '1.25rem', fontWeight: 900, marginBottom: '1rem', color: '#fff' }}>Get a Free Scottsdale Estimate</div>
              {submitSuccess ? (
      ...
      <section className={styles.section} style={{ background: '#fff' }}>
        <div className="container">
          ...
          <h2 className={styles.sectionTitle}>Why Homeowners in Scottsdale Are Removing Their Pools</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginTop: '3rem' }}>
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', lineHeight: 1.7 }}>
                The harsh Arizona sun combined with our hard water takes a massive toll on pool pumps, filters, and plaster. Average annual maintenance costs in Scottsdale now exceed $2,500. Over ten years, that is $25,000 completely wasted on a pool you barely use.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', lineHeight: 1.7 }}>
                Yards in Scottsdale are valuable real estate. By removing an oversized, outdated pool, you instantly unlock hundreds of square feet of usable outdoor space for a modern patio, an outdoor kitchen, a lush garden, or a safe play area for children and pets.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={styles.section} style={{ background: 'var(--bg-dark)', color: '#fff' }}>
        <div className="container">
          ...
          <h2 className={styles.sectionTitle} style={{ color: '#fff' }}>The Scottsdale Pool Demolition Process</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
            {[
              { title: 'Step 1: City Permits & Utility Marking', text: 'Before any heavy machinery arrives, we file all necessary demolition permits directly with the city of Scottsdale. We also schedule Blue Stake utility marking to ensure all underground gas, water, and electrical lines are identified and protected.' },
              { title: 'Step 2: Safe Drainage & Neutralization', text: 'We safely drain thousands of gallons of pool water in compliance with Scottsdale environmental regulations. We never flood your neighbors yard or cause street damage.' },
              { title: 'Step 3: Heavy Equipment Excavation', text: 'Using our specialized mini-excavators and skid steers, we break apart the concrete shell. For the hard caliche and rocky terrain common in Scottsdale, we deploy hydraulic breakers to shatter the hardpan and pool floor, preventing future water pooling.' },
              { title: 'Step 4: Debris Haul-Off', text: 'We do not bury debris unless performing a specific partial fill-in. For full removals, we load all rebar, concrete, plaster, and plumbing into dump trucks and haul it to authorized Scottsdale recycling facilities.' },
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            <div>
              ...
              <h2 className={styles.sectionTitle}>How Much Does Pool Removal Cost in Scottsdale?</h2>
              <p style={{ color: 'var(--text-muted)', lineHeight: 1.8, marginTop: '1.5rem' }}>
                Every backyard in Scottsdale is unique. The final price of your demolition project will depend heavily on the accessibility of your yard, the total square footage of the pool, and whether you opt for a partial fill-in or a complete structural removal.
              </p>
              <ul style={{ marginTop: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', color: 'var(--text-muted)' }}>
                ...
                <li><strong>Soil Type:</strong> The hard caliche and rocky terrain in Scottsdale requires aggressive breaking and specialized fill dirt.</li>
            ...
            <div style={{ background: '#fff', padding: '2.5rem', borderRadius: '12px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', borderTop: '6px solid var(--accent-secondary)' }}>
              <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                <div style={{ color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 800, fontSize: '0.9rem', letterSpacing: '0.05em' }}>Average Scottsdale Price Range</div>
                <div style={{ fontSize: '3rem', fontWeight: 900, color: '#111', margin: '0.5rem 0' }}>$5,500 – $14,000</div>
      ...
      <section className={styles.section} style={{ background: '#fff' }}>
        <div className="container">
          <h2 className={styles.sectionTitle} style={{ textAlign: 'center', marginBottom: '2rem' }}>Scottsdale Regulations & Permits</h2>
          <div style={{ maxWidth: '800px', margin: '0 auto', color: 'var(--text-muted)', lineHeight: 1.8 }}>
            <p style={{ marginBottom: '1.5rem' }}>
              Attempting to remove a pool without the proper permits in Scottsdale can result in massive fines, stop-work orders, and severe legal issues when you attempt to sell your home. 
            </p>
            <p style={{ marginBottom: '1.5rem' }}>
              We are fully licensed demolition contractors. We pull all necessary permits through the city of Scottsdale, schedule the mandatory open-hole inspections, and ensure that the compaction reports meet all local municipal codes.
            </p>
            <p>
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ display: 'grid', gap: '2rem' }}>
            <div style={{ borderBottom: '1px solid var(--border-dark)', paddingBottom: '1.5rem' }}>
              <h3 style={{ color: 'var(--accent-primary)', fontSize: '1.1rem', marginBottom: '0.75rem' }}>Do I need a permit to remove a pool in Scottsdale?</h3>
              <p style={{ color: 'var(--text-inverse-muted)', lineHeight: 1.7 }}>Yes, Scottsdale requires a demolition permit for pool removal to ensure proper backfill and safety. We handle the entire permitting process for you, from application to final city inspection.</p>
            </div>
            <div style={{ borderBottom: '1px solid var(--border-dark)', paddingBottom: '1.5rem' }}>
              <h3 style={{ color: 'var(--accent-primary)', fontSize: '1.1rem', marginBottom: '0.75rem' }}>Does the hard caliche and rocky terrain in Scottsdale affect the demolition process?</h3>
              <p style={{ color: 'var(--text-inverse-muted)', lineHeight: 1.7 }}>Yes, Scottsdale is known for its hard caliche and rocky terrain. This requires heavy-duty excavation equipment to break through hardpan layers and ensure the imported fill dirt is compacted correctly to prevent future sinking.</p>
            </div>
            <div style={{ borderBottom: '1px solid var(--border-dark)', paddingBottom: '1.5rem' }}>
              <h3 style={{ color: 'var(--accent-primary)', fontSize: '1.1rem', marginBottom: '0.75rem' }}>How long does the pool removal process take?</h3>
              <p style={{ color: 'var(--text-inverse-muted)', lineHeight: 1.7 }}>Most pool removals in Scottsdale take between 3 to 5 days of physical labor, depending on access and pool type. The permitting process can add 1-2 weeks before we break ground.</p>
            </div>
            <div style={{ borderBottom: '1px solid var(--border-dark)', paddingBottom: '1.5rem' }}>
              <h3 style={{ color: 'var(--accent-primary)', fontSize: '1.1rem', marginBottom: '0.75rem' }}>Will removing my pool lower my property value in Scottsdale?</h3>
      ...
      <section className={styles.section} style={{ textAlign: 'center', padding: '6rem 0', background: 'var(--bg-light)' }}>
        <div className="container">
          <h2 className={styles.sectionTitle} style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)' }}>
            Ready to reclaim your backyard in Scottsdale?
          </h2>
