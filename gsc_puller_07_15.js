...
const OUTPUT_DIR = path.join(__dirname, 'gsc/07-15-2026');
const OUTPUT_FILE = path.join(OUTPUT_DIR, '07-15-2026.md');
...
async function pullGSCData() {
  ...
  try {
    ...
    // Pull last 30 days (2026-06-15 to 2026-07-14)
    ...
    // Pull previous 30 days (2026-05-16 to 2026-06-14)
    ...
    report += `Recent Period: 2026-06-15 to 2026-07-14\n`;
    report += `Previous Period: 2026-05-16 to 2026-06-14\n\n`;
